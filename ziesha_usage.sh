...
function _usage_set () {
  ...
  $OPTIONS
    ...
    -c | --share-capacity : Share Capacity [0;49;96m(Default is $SHARE_CAPACITY)[0m
    -e | --share-easiness : Share Easiness [0;49;96m(Default is $SHARE_EASINESS)[0m
    -o | --reward-ratio   : Reward Ratio   [0;49;96m(Default is $REWARD_RATIO)[0m
    -y | --reward-delay   : Reward Delay   [0;49;96m(Default is $REWARD_DELAY)[0m
    -z | --zoro-seed      : Zoro Seed
    -t | --update-dat     : update.dat file path
                            [0;49;96m(Default is $UPDATE_DAT)[0m
    -p | --deposit-dat    : deposit.dat file path
                            [0;49;96m(Default is $DEPOSIT_DAT)[0m
    -w | --withdraw-dat   : withdraw.dat file path
                            [0;49;96m(Default is $WITHDRAW_DAT)[0m
    -h | --help           : Shows this message
